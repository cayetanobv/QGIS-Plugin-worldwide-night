...
# Form implementation generated from reading ui file 'worldwidenight_dialog_base.ui'
#
# Created: Tue May 12 01:51:40 2015
...
class Ui_worldwidenightDialogBase(object):
    def setupUi(self, worldwidenightDialogBase):
        ...
        self.dateTimeEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(2015, 1, 1), QtCore.QTime(11, 0, 0)))
        self.dateTimeEdit.setDate(QtCore.QDate(2015, 1, 1))
        self.dateTimeEdit.setTime(QtCore.QTime(11, 0, 0))
    ...
    def retranslateUi(self, worldwidenightDialogBase):
        worldwidenightDialogBase.setWindowTitle(_translate("worldwidenightDialogBase", "Worldwide night", None))
        ...
        self.labelOutput.setText(_translate("worldwidenightDialogBase", "2) Select destination folder for SHP.", None))
